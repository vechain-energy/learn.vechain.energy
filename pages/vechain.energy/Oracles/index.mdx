...
You can check the data and status provided by vechain.energy's Oracles at https://status.oracle.vechain.energy

<Callout type="info">
  If you choose to use the public deployment, we encourage you to run a reporter
  to enhance the oracle's decentralization. If this interests you, please [open
  an issue](https://github.com/vechain-energy/oracle.vechain.energy/issues/new)
  or send us an email at [oracle@vechain.energy](mailto:oracle@vechain.energy).
</Callout>
