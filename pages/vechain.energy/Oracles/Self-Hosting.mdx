...
* Deploy a `OracleAggregatorUpgradable` contract using the instructions at https://github.com/vechain-energy/oracle.vechain.energy/tree/main/contracts.
* Call `addSource(address)` for each contract used as source.
...
* https://oracle.vechain.energy/vet-usd
